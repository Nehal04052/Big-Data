...
# MAGIC %md
# MAGIC #Get Missing Values Complete
...
# MAGIC %md
# MAGIC #Get Categories and Counts of Categorical Variables
...
rfr = RandomForestRegressor(random_state=12529)
